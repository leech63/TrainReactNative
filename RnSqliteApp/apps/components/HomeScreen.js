            ...
            txn.executeSql(
                ...
                function (tx, res){
                   ...
                   if (res.rows.length === 0) {
                    ...
                    txn.executeSql('CREATE TABLE IF NOT EXISTS table_user(user_id INTEGER PRIMARY KEY AUTOINCREMENT,user_name TEXT NOT NULL, user_contact TEXT, user_address TEXT NOT NULL)',[]);
